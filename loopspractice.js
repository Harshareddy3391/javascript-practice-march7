...
while(cardata < cars.length){
    console.log(cars[cardata].brand)
    cardata++;
}
...
console.log("print red colors")

let redc=0

while( redc < cars.length){
    if(cars[redc].color == "White"){
        console.log(cars[redc].brand)
    }
    redc++;
}


console.log("print 1lack below cars")
